<template>
<div>
  <nav class="navbar navbar-dark navbar-expand navigation-clean" :style="{'backgroundColor': navColor}">
    <div class="container">
      <nuxt-link class="navbar-brand text-light" :to = "'/'">SKKU Capstone</nuxt-link>
